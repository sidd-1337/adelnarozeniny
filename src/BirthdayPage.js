...
const BirthdayPage = () => {
    ...
    const [flowers] = useState([
        { src: img1, passwordHash: '$2a$12$Lv8K.F6Y7vAakS56Ne81CuixckVekBug4QSRSHA2XA.3J47nrYhfu', message: 'Každý tvůj krok je progres, i když to zrovna nevidíš.', component: <FlowerMessage1/>, position: generateRandomPosition(existingPositions,  flowerSize), animation: animations[Math.floor(Math.random() * animations.length)] },
